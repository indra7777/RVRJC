<?php
$resf2=mysqli_query($conf,"SELECT * FROM honordetails WHERE facultyid='$facultyIDpart' and dept='$branch' order by sno ASC") ;  $rownumf2=mysqli_num_rows($resf2); //echo "echo-$facultyIDpart-$branch-$rownumf1";
...
Honors Obtained</font></td>"; echo "</tr></table>"; 

echo "<table style='margin: 0 auto; border-collapse: collapse' align='center' border='1' bordercolor=$dborder width=$dtablewidth>";
echo "<tr style='font-size:12px; font-weight:bold; color:white;' bgcolor=$dhedcolor height=30px><td>Description </td>"; echo "</tr>"; 
...
echo "<td align='left'><font style='color:$color1;'>$description</td>"; echo "</tr>"; $color = !$color;} echo "</table>"; echo "<br> ";
