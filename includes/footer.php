 <!-- Footer section -->
 <section data-aos="" data-aos-duration="1000" class="container-fluid text-white" style="background-color: #212331;" class="footer-container">
   <footer class="footer row row-cols-8 pt-5 border-top">
     <div class="col-sm-4 col-md-8 order-md-0 order-lg-0 col-lg-4">
       <div class="d-flex justify-content-center">
         <img src="./images/footer_rvr-new.png" width="80%" class="footer-rvr w-20 img-fluid" alt="RVRJCCE">
       </div>
       ...
       <ul class="list-unstyled d-flex justify-content-center gap-2 social-links">
         <li><a href="https://www.youtube.com/c/RVRJCCollegeofEngineering" target="_blank" id="youtube-icon"><img class="m-1" style="width:30px;height:30px" src="./icons/svgs/youtube-svg.svg" alt="YouTube"></a></li>
         <li><a href="https://www.facebook.com/RVR-JC-College-of-Engineering-Autonomous-442983819071705" target="_blank" id="facebook-icon"><img class=" m-1" style="width:30px;height:30px" src="./icons/svgs/facebook-svg.svg" alt="facebook"></a></li>
         <li><a href="https://twitter.com/rvrjc_official" target="_blank" id="twitter-x-icon"><img class="m-1" style="width:30px;height:30px" src="./icons/svgs/x-svg.svg" alt="twitter"></a></li>
         <li><a href="https://www.instagram.com/rvrjcce.official/" target="_blank" id="instagram-icon"><img class="m-1" style="width:30px;height:30px" src="./icons/svgs/instagram-svg.svg" alt="instagram"></a></li>
         <li><a href="https://www.linkedin.com/school/r.v.r.-&-j.c.-college-of-engineering/" target="_blank" id="linkedin-icon"><img class="m-1" style="width:30px;height:30px" src="./icons/svgs/linkedin-svg.svg" alt="Linkedin"></i></a></li>
       </ul>
     </div>
     ...
     <div class="col-sm-4 col-md-4 order-md-1 order-lg-0 col-lg-4">
       ...
       <iframe title="Loaction of RVR&JC College Of Engineering" width="100%" height="100%" loading="lazy" referrerpolicy="no-referrer-when-downgrade" style="border:2px solid ghostwhite;border-radius:10px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3830.3316190062897!2d80.32332137516829!3d16.254765734444238!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a4a76e740000001%3A0xc41c8498715c6da0!2sR.V.R.%20%26%20J.C.College%20of%20Engineering!5e0!3m2!1sen!2sin!4v1699157234638!5m2!1sen!2sin"></iframe>
     </div>
